...
public class For01 {
	...
	public static void main(String[] args) {
		/*
		 ...
		 초기화 : 반복문이 시작될 때 한 번만 실행되는 부분으로, 반복 변수를 초기화하는 역할을 한다.
		...
		*/
		...
		System.out.println("3부터 5까지의 합 : " + sum1);
